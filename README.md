...
An AWS reference implementation for building video semantic search using Amazon Nova multimodal embeddings. This repository contains two sub-projects demonstrating different aspects of the solution.

## Sub-Projects

### [Video Semantic Search with Nova MME](video-semantic-search-w-nove-mme/)
